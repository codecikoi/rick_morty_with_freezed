...
class _$CharacterStateLoading implements CharacterStateLoading {
  _$CharacterStateLoading({final String? $type}) : $type = $type ?? 'loading';
...
class _$CharacterStateLoaded implements CharacterStateLoaded {
  _$CharacterStateLoaded({required this.characterLoaded, final String? $type})
      : $type = $type ?? 'loaded';
...
class _$CharacterStateError implements CharacterStateError {
  _$CharacterStateError({final String? $type}) : $type = $type ?? 'error';
